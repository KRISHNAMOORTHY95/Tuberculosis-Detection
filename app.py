...
pages = ["🏠 Home", "📊 Data Analysis", "🧠 Training", "🔍 Prediction", "👨‍💻 About"]
...
def create_sample_data():
    ...
    data = {
        ...
        'Diagnosis': np.random.choice(['Normal', 'TB'], 100, p=[0.6, 0.4]),
        'Image_Quality': np.random.choice(['Good', 'Fair', 'Poor'], 100, p=[0.7, 0.2, 0.1])
    }
...
<div style="text-align: center; color: #666; padding: 20px;">
     TB Detection | Built with ❤ using Streamlit | © 2025 Krishnamoorthy K
</div>
""", unsafe_allow_html=True)
